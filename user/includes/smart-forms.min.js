!(function i(s, a, u) {
...
})(
    {
        1: [
            function (e, t, n) {
                ...
                var o = e("./src/Form"),
                    ...
                    u = (e("./src/helpers/messages"), "https://bootstrapstudio.io/smartform-handler"),
                ...
                function y(e) {
                    m({ operation: c, message: e.message || "", status: e.status || "loading", title: e.title || "" }, "*");
                }
                function m(e, t) {
                ...
                function v() {
                    ...
                    e.redirectURL && s(e.redirectURL) ? (window.location.href = e.redirectURL) : (i(f.element, "smart-form-sent"), y({ status: "success", title: e.title, message: e.message }), f.reset());
                }
                function b() {
                    var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
                    i(f.element, "smart-form-error"), y({ status: "error", title: e.title, message: e.message });
                }
                a(p, {
                    position: "fixed",
                    top: "50%",
                    ...
                    a(h, { position: "fixed", display: "block", top: "0", width: "100%", height: "100%", backgroundColor: "rgba(0,0,0,0.7)", zIndex: "9998" }),
                    r(p, "load", null, function () {
                        if (!f) return;
                        10485760 < f.getFileSize() ? y({ status: "error", title: f.getMessage("filesize", "title", f.getMessage("error", "title")), message: f.getMessage("filesize", "message") }) : m({ operation: "showRecaptcha" }, "*");
                    }),
            ...
            { "./src/Form": 6, "./src/helpers/addStyles": 10, "./src/helpers/isValidURL": 11, "./src/helpers/messages": 12, "./src/helpers/on": 13, "./src/helpers/trigger": 14 },
        ],
        2: [
            function (e, t, n) {
                "use strict";
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        for (var e = [], t = 0; t < this.element.files.length; t++)
                                            e.push({ name: (this.isNameSet() ? this.getName() : this.identifier) + (1 < this.element.files.length ? "[]" : ""), value: this.element.files[t] });
                                        return e;
                                    },
                                },
                                {
        ...
        6: [
                ...
                var i = e("./Component"),
                    ...
                    r = (function (e) {
                        function r(e, t) {
                            ...
                            return (n.options = t), (n.recipient = e.getAttribute("data-bss-recipient")), (n.redirectURL = e.getAttribute("data-bss-redirect-url") || ""), n.initialize(), n;
                        }
                        return (
                            (function (e, t) {
                                if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function, not " + typeof t);
                            ...
                            o(r, [
                                ...
                                },
                                {
                                    ...
                                    value: function (e, t) {
                                        ...
                                        switch (e.tagName.toLowerCase()) {
                                            case "input":
                                                n = "radio" === e.type ? new u(e, this, t) : "checkbox" === e.type ? new s(e, this, t) : "file" === e.type ? new c(e, this, t) : new a(e, this, t);
                                                break;
                                            case "select":
                                                n = new l(e, this, t);
                                                break;
                                            ...
                                            n.forEach(function (e) {
                                                if (e.hasValue())
                                                    if (e.hasMultipleValues()) {
                                                        var t = { name: e.getName(), data: { type: e.getType(), value: [].concat(e.getValue()) } };
                                                        "checkbox" === e.getType() &&
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        return [0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "", 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : ""]
                                            .filter(function (e) {
                                                return !!e;
                                            })
                                            .join(".");
                                ...
                                },
                                {
                                    ...
                                    value: function (e, t) {
                                        ...
                                        r = r.concat(n, i);
                                        for (var s = 0; s < r.length; s++) o.append(r[s].name, r[s].value);
                                        o.append("data", JSON.stringify(this.getData())), f.send({ url: e, method: t, body: o, error: this.onError.bind(this), success: this.onSuccess.bind(this), beforeSend: this.beforeSend.bind(this) });
                                    },
                                },
                                {
                                    key: "reset",
                                ...
                                },
                                {
                                    key: "beforeSend",
                                    value: function () {
                                        var e = { title: this.getMessage("loading", "title"), message: this.getMessage("loading", "message") };
                                ...
                                },
                                {
                                    key: "onSuccess",
                                    value: function (e) {
                                        var t = { title: this.getMessage("success", "title"), message: this.getMessage("success", "message"), redirectURL: this.redirectURL };
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        var t = {};
                                        e && e.error && ((t.title = this.getMessage(e.error.type, "title", this.getMessage("error", "title"))), (t.message = this.getMessage(e.error.type, "message"))),
                                            (t.title && t.message) || ((t.title = t.title || this.getMessage("error", "title")), (t.message = t.message || this.getMessage("error", "message"))),
            ...
            { "./Ajax": 2, "./Checkbox": 3, "./Component": 4, "./FileField": 5, "./FormField": 7, "./RadioButton": 8, "./Select": 9, "./helpers/messages": 12 },
        ],
        7: [
            function (e, t, n) {
                "use strict";
                        ...
                        return (
                            ...
                            r(o, [
                                ...
                                },
                                {
                                    key: "getData",
                                    value: function () {
                                        return { name: this.getName(), data: { type: this.getType(), value: this.getValue() } };
                                    },
                                },
                                {
                                    key: "getLabel",
                            ...
                            r(n, [
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        var e = this.getLabel(),
                                            t = void 0;
                                        return e && (t = e.text), { value: t || o(n.prototype.__proto__ || Object.getPrototypeOf(n.prototype), "getValue", this).call(this), active: this.element.checked };
                                    },
                                },
                            ]),
                            n
                        ...
                        return (
                            ...
                            o(r, [
                                ...
                                },
                                {
                                    key: "getValue",
                                    value: function () {
                                        for (var e = [], t = 0; t < this.options.length; t++) this.options[t].selected && e.push({ value: this.options[t].textContent });
                                        return e;
                                    },
                                },
                            ]),
                ...
                t.exports = function (e, t, a, u, n) {
                    ...
                    (n = n || !1),
                        (l = e ? ("string" == typeof e ? document.querySelector(e) : e) : document) &&
                            ((r = n
                                ? function (e) {
                                      for (var t = l.querySelectorAll(a), n = e.target, r = 0, o = t.length; r < o; r++)
